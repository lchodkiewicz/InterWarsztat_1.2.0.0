...
AjaxDataTable.render_page_index = function (id, current_page, total_page, page_size, total) {
    var paging_html = "<div class=\"pagination\"><ul>";
        ...
        function (table_model) {
            ...
            AjaxDataTable.settings[id].dataProvider(
                ...
                function (table_data) {
                    ...
                    table_container.html(paging_html + "<br class=\"ajax-data-table-break\" />" + table_html + bulk_actions_html + "<br class=\"ajax-data-table-break\" />" + paging_html + "<br class=\"ajax-data-table-break\" />");
